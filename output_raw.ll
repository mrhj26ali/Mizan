...
define void @"proc_الرئيسي"()
{
entry:
  %".2" = bitcast [58 x i8]* @"__log_1" to i8*
  call void @"mizan_log"(i8* %".2")
  %".4" = bitcast [56 x i8]* @"__log_2" to i8*
  call void @"mizan_log"(i8* %".4")
  ret void
}
...
entry:
  ...
  %".3" = bitcast [10 x i8]* @"__dev_ip_3" to i8*
  %".4" = call i8* @"mizan_modbus_connect"(i8* %".3", i32 5020)
  store i8* %".4", i8** @"__modbus_ctx"
  %".6" = bitcast [10 x i8]* @"__mq_host_4" to i8*
  %".7" = bitcast [14 x i8]* @"__mq_cid_5" to i8*
...
flush_cond:
  %".19" = load i32, i32* %"fi"
  %".20" = icmp slt i32 %".19", %"flush_n"
  br i1 %".20", label %"flush_body", label %"flush_end"
flush_body:
  %".22" = load i32, i32* %"fi"
  %".23" = getelementptr inbounds [64 x i32], [64 x i32]* @"__wq_addrs", i32 0, i32 %".22"
  %".24" = getelementptr inbounds [64 x double], [64 x double]* @"__wq_values", i32 0, i32 %".22"
  %".25" = load i32, i32* %".23"
  %".26" = load double, double* %".24"
  call void @"mizan_modbus_write"(i8* %"mb_out", i32 %".25", double %".26")
  %".28" = add i32 %".22", 1
  store i32 %".28", i32* %"fi"
  br label %"flush_cond"
flush_end:
  ...
  %".33" = icmp ne i32 %"pending", -1
  br i1 %".33", label %"flush_end.if", label %"flush_end.endif"
flush_end.if:
...
flush_end.endif:
  ...
  br i1 %".38", label %"flush_end.endif.if", label %"flush_end.endif.endif"
flush_end.endif.if:
